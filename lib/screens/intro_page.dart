                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Kamu bisa membeli barang elektronik dengan cara di klik.',
                        textAlign: TextAlign.right,
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 32, vertical: 16.0),
                      child: Text(
                        'Kita bisa mengirim ke semua negara.',
                        textAlign: TextAlign.right,
                        style: TextStyle(color: Colors.grey, fontSize: 12.0),
                      ),
                    ),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(
                          horizontal: 32, vertical: 16.0),
                      child: Text(
                        'Kamu bisa melacak pengiriman dengan aplikasi pelacak.',
                        textAlign: TextAlign.right,
                        style: TextStyle(color: Colors.grey, fontSize: 12.0),
                      ),
                    ),
